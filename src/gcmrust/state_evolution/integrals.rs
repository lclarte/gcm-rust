...
pub fn integrate_for_mhat(m : f64, q : f64, v : f64, vstar : f64, channel : &impl base_channel::Channel, data_model : &impl base_model::Partition) -> f64{
...
pub fn integrate_for_qhat(m : f64, q : f64, v : f64, vstar : f64, channel : &impl base_channel::Channel, data_model : &impl base_model::Partition) -> f64{
    let mut somme = 0.0_f64;
    let ys    = [-1.0, 1.0];
...
pub fn integrate_for_vhat(m : f64, q : f64, v : f64, vstar : f64, channel : &impl base_channel::Channel, data_model : &impl base_model::Partition) -> f64{
    let mut somme = 0.0_f64;
    let ys    = [-1.0, 1.0];
